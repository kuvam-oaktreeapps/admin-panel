...
router.post(
  ...
  async (req: express.Request, res: express.Response) => {
    try {
      const response = await AdminUserController.registerUser(req.body as AdminUserRegisterDto);
...
router.post(
  ...
  async (req: express.Request, res: express.Response) => {
    try {
      const response = await AdminUserController.login(req.body as AdminUserLoginDto);
