...
import { UpdatePasswordDto, UserLoginDto, UserRegisterDto } from "./User.dto";
...
describe("UserRouter Test", () => {
  ...
  before(async () => {
    ...
    app = await api.getApp(UserRouter);
  ...
  describe("Change Password", () => {
    ...
    before(async () => {
      request = () => chai.request(app).put("/password");
      body = {
